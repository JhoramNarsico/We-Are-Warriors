        ...
        fightButton.addEventListener("click", () => {
          try {
            ...
            if (!window.GameState.gameActive && !window.GameState.gameOver) {
              ...
              window.Game.startGameUpdateLoop(); // Ensure loop starts
              window.UI.showFeedback("Battle started!");
            } else {
              console.log("Cannot start: gameActive or gameOver is true");
              window.UI.showFeedback("Cannot start battle: Game already active or over!");
            }
          } catch (e) {
